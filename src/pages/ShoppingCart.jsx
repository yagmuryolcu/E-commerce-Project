    ...
    // Redux store'dan sepet verilerini al
    const cartItems = useSelector(state => state.shoppingCart.cart);
    
    // Her ürün için seçilen renk state'i
    ...
    return (
        ...
        <div className="container mx-auto px-4 py-8 md:px-8 max-w-7xl">
            ...
            <div className="lg:col-span-2 space-y-4">
                ...
                const currentColor = selectedColors[product.id] || colors[0].code;
                ...
                return (
                    ...
                    <div className="flex gap-4">
                        ...
                        {/* Color Selection */}
                        <div className="mb-4">
                            <p className="text-sm font-semibold text-[#252B42] mb-2">Color Section:</p>
                            <div className="flex gap-2">
                            {colors.map((color, index) => (
                                <button
                                key={index}
                                onClick={() => updateColor(product.id, color.code)}
                        ...
                        <div className="flex items-center justify-between flex-wrap gap-4">
                            ...
                            <span className="text-sm font-semibold text-[#252B42]">Qunatity:</span>
                            <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                                <button
                                onClick={() => updateQuantity(product.id, item.count - 1)}
            ...
            <div className="lg:col-span-1">
                ...
                <div className="flex gap-2">
                    ...
                    />
                    <button
                    className="px-4 py-3 bg-[#23A6F0] text-white rounded-md font-semibold hover:bg-blue-600 transition-colors text-sm"
                    >
                    Apply
                    </button>
                </div>
